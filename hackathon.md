# {Tech: Europe} Paris AI Hackathon Manual

<aside>
🏆

**>10k€ Price Pool distributed across cash, hardware & credits**
...
- **Submit your project by 19:00**
- **Be a team of max. 5 people**
- **Use min. 1 partner technologies** (listed under resources)
...
- **5 finalist teams** will advance to the Finalist Stage
...
- These top 5 teams will be awarded the Finalist Stage Prizes
...
**🏆 Track Prize:** Qualification for the Finalist Stage (5x)
...
### [**fal](https://fal.ai/)** - Best use of [**fal**](https://fal.ai/)

**To compete in this challenge you have to:**

- Use [**fal](https://fal.ai/)** in your project
- Confirm in your project submission that you used it
- What they are looking for:
    - Use fal-powered generative media models in a core feature
    - Do something creative
    - Do something advanced (could be a LoRa, a workflow, using genmedia CLI etc.)

**🏆 The best use of [fal](https://fal.ai/) will win:**

- 1000 USD fal Credits

### SLNG - Best use of SLNG

**To compete in this challenge you have to:**

- Use SLNG in your project
- Confirm in your project submission that you used it

**🏆 The best use of SLNG will win:**
...
- [OpenAI](http://openai.com) - Frontier AI Models
    
    Vouchers for both api keys and codex will be sent out the the emails linked to your luma accounts
    
    To redeem the codex codes go to http://chatgpt.com/p/<promo code>
    
- [**Gradium](http://Gradium.ai)** - Voice AI models for realtime interactions including TTS and STT
    
    Docs: https://docs.gradium.ai/
    
    SDKs: https://github.com/gradium-ai
    
    Code for more credits : PARISHAC1
    
- [**fal](https://fal.ai/)** - Generative Media platform for developers
    - Use code: paris-hack
    - Claim the voucher on the billing page or click [here](https://fal.ai/coupon-claim/paris-hack)
    - Enjoy $50 worth of credits
- [**Pioneer](https://pioneer.ai/) by [Fastino](https://fastino.ai/)** - Models that train themselves
    
    Check out their Hackathon onboarding page [here](https://www.notion.so/35f8413d474480a591d9cd35305503b3?pvs=21).
...
- [**Tavily**](https://www.tavily.com/) - Real-time search, extraction, research, and web crawling through a single, secure API
    ...
    - If you run out of Credits use this code to generate more credits: TVLY-HBFB4VJ0
    - Docs: https://docs.tavily.com/welcome
    
    [Tavily Hacker Guide (2).pdf](attachment:e8f201ce-6da1-404c-beb0-0d18ad068b24:Tavily_Hacker_Guide_(2).pdf)
    
- [**SLNG**](http://slng.ai/) - Global Voice AI Infrastructure
    
    Generous free tier. [Docs](https://docs.slng.ai)
...
- **Do we need to use the partner technologies?**
    ...
    You must use at least 1 **provided technologies** (Google Deepmind, Fal, Gradium).
